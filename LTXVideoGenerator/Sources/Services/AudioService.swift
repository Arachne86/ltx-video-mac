...
enum MusicGenre: String, CaseIterable, Identifiable {
    ...
    // ⚡ Bolt Optimization: Use lazily-initialized static let instead of computed var
    // Impact: Prevents re-computing filtered genre lists on every UI render pass in ForEach
