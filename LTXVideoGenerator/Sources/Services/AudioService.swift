...
enum MusicGenre: String, CaseIterable, Identifiable {
    ...
    // ⚡ Bolt Optimization: Use statically cached `let` instead of computed `var`.
    // Impact: Prevents re-filtering `allCases` on every UI render pass when used in ForEach loops.
