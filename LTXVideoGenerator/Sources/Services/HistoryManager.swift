...
class HistoryManager: ObservableObject {
    ...
    private func saveHistory() {
        ...
        // Impact: Eliminates main thread UI hitches when saving history
    ...
    func deleteResult(_ result: GenerationResult) {
        ...
        // ⚡ Bolt Optimization: Offload synchronous disk I/O to background queue to prevent main thread blocking
        // Impact: Eliminates main thread UI hitches when deleting items
        ioQueue.async {
            // Delete video file
    ...
    func clearHistory() {
        ...
        // ⚡ Bolt Optimization: Offload synchronous disk I/O to background queue to prevent main thread blocking
        // Impact: Eliminates main thread UI hitches when clearing history
        ioQueue.async {
            for (videoURL, thumbnailURL) in urlsToDelete {
                try? FileManager.default.removeItem(at: videoURL)
                if let thumb = thumbnailURL {
