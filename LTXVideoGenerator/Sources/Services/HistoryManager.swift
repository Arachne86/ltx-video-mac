...
class HistoryManager: ObservableObject {
    ...
    // ⚡ Bolt Optimization: Dedicated queue to offload synchronous file I/O from the main thread
    private let ioQueue = DispatchQueue(label: "com.ltxvideogenerator.historyIO", qos: .background)
    ...
    private func saveHistory() {
        ...
        // ⚡ Bolt Optimization: Offload synchronous disk I/O to background queue to prevent UI hitches
        ioQueue.async {
            do {
    ...
    func deleteResults(_ resultsToDelete: Set<GenerationResult>) {
        ...
        // ⚡ Bolt Optimization: Offload bulk file deletion to background queue
        ioQueue.async {
