...
class PresetManager: ObservableObject {
    ...
    private func savePresets() {
        ...
        // ⚡ Bolt Optimization: Offload synchronous disk I/O to background serial queue. Impact: Eliminates main thread blocking during JSON encoding and file writing, improving UI responsiveness while preserving write order.
