...
class PresetManager: ObservableObject {
    ...
    private let ioQueue = DispatchQueue(label: "com.ltxvideogenerator.presets.io", qos: .utility)
    ...
    private func savePresets() {
        ...
        // Impact: Eliminates main thread blocking and UI hitches during preset saving
        let localFile = self.presetsFile
