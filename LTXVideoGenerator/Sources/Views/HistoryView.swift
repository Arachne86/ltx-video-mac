...
struct HistoryThumbnailView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            // ⚡ Bolt Optimization: Offload synchronous disk I/O (NSImage init) to a background task
            // Impact: Eliminates main thread blocking and jank when scrolling through the HistoryView list
