...
struct HistoryThumbnailView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            // ⚡ Bolt Optimization: Offload synchronous disk I/O to prevent UI hitches during scrolling
            // Impact: Eliminates main thread blocking when loading thumbnails for reused views
