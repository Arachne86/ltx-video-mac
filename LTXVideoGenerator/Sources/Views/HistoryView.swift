    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            .task(id: result.thumbnailURL) {
                // ⚡ Bolt Optimization: Offload synchronous disk I/O to a detached background task.
                // Impact: Eliminates main thread blocking when scrolling through large video histories, preventing UI hitches.
                // Reset image when recycling the view for a new URL.
                thumbnailImage = nil
